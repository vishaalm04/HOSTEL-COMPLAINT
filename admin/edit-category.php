                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h5 class="m-b-10">Update Complaint Type</h5>
                        </div>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="dashboard.php"><i class="feather icon-home"></i></a></li>
                            <li class="breadcrumb-item"><a href="category.php">Update Complaint Type</a></li>
...
?>
                                <form method="post">
                                    ...
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Complaint Type Name</label>
